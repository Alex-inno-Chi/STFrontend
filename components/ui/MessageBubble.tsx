...
export default function MessageBubble({
 ...
 //add logic for right click on message for edit

  return (
    <div
      className={`flex flex-col max-w-[70%] ${isMyOwnMessage ? "ml-auto items-end" : "mr-auto items-start"}`}
    >
      <div
        className={`rounded-lg px-3 py-2 ${isMyOwnMessage ? "bg-blue-500 text-white" : "bg-gray-200 text-gray-900"}`}
      >
        {!isMyOwnMessage && (
